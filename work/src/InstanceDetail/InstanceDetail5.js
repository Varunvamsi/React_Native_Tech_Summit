...
class InstanceDetail5 extends React.Component{
  constructor() {
    super();
    this.state = {
      data: [
        {
          Instance_Name:'Instance Name: Z1:',
          Instance_Type: 'Instance Type: Memory Optimised Instances',
...
<View style={[{ width: "10%"}]}>
<Button title="+" onPress ={ () => this.props.navigation.navigate('InstanceNumber5')} />
</View>
</View>
...
export default InstanceDetail5;
